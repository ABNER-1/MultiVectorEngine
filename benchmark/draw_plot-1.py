...
def draw_l2(image_name):
    ...
    ivf_dir1 = "/root/results/l2/ivfflat/test1"
    hnsw_dir1 = "/root/results/l2/hnsw/test1"
    ivf_dir2 = "/root/results/l2/ivfflat/test2"
    ...
    ivf_metric_data2 = get_metric_data(ivf_dir2 , baseline_file, "NRA4096_4096 IVFFLAT")
